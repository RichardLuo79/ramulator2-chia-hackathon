...
// Fixed latency plus an arrival-ordered bandwidth queue. This is NOT an exact
// gem5 SimpleMemory port: gem5 rejects bandwidth-busy arrivals; this baseline
// accepts them and charges the waiting time internally. pipe=0 corresponds
// to zsim's constant-latency abstraction (excluding its coherence interface).
// See doc/baseline_source_audit.md for source references and adaptations.
