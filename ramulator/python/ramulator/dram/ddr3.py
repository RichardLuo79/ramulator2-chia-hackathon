...
class DDR3(DRAMStandard):
    ...
    def resolve_secondary_timings(cls, timing_dict, org_dict):
        ...
        if dq in (4, 8, 16):
            ...
            page_size_bytes = -1
        timing_dict["nRRD"] = cls._resolve_nRRD(page_size_bytes, timing_dict["rate"])
    ...
    @staticmethod
    def _resolve_nRRD(page_size_bytes, rate):
        _table = {
            (1024, 800):  4,
            (1024, 1066): 4,
            (1024, 1333): 4,
...
# ---- DDR3 JEDEC preset data (JESD79-3F, including Section 2.11.5 for 8 Gb) ----
...
DDR3.org_presets = {
    ...
    "DDR3_8Gb_x4":  {"density": 8192, "dq": 4,  "channel_width": 64, "rank": 1, "bank": 8, "row": 1<<16, "column": 1<<12},
    "DDR3_8Gb_x8":  {"density": 8192, "dq": 8,  "channel_width": 64, "rank": 1, "bank": 8, "row": 1<<16, "column": 1<<11},
...
DDR3.timing_presets = {
    "DDR3_800D": {
        "rate": 800, "nBL": 4,
        "nCL": 5, "nRCD": 5, "nRP": 5, "nRAS": 15, "nRC": 20,
        "nWR": 6, "nRTP": 4, "nCWL": 5,
        "nCCD": 4, "nWTR": 4,
        "tCK_ps": 2500,
    ...
    "DDR3_800E": {
        "rate": 800, "nBL": 4,
        "nCL": 6, "nRCD": 6, "nRP": 6, "nRAS": 15, "nRC": 21,
        "nWR": 6, "nRTP": 4, "nCWL": 5,
        "nCCD": 4, "nWTR": 4,
        "tCK_ps": 2500,
        "nCS": 2,  # Ramulator guesstimate
    ...
    "DDR3_1066E": {
        "rate": 1066, "nBL": 4,
        "nCL": 6, "nRCD": 6, "nRP": 6, "nRAS": 20, "nRC": 26,
        "nWR": 8, "nRTP": 4, "nCWL": 6,
        "nCCD": 4, "nWTR": 4,
        "tCK_ps": 1875,
        "nCS": 2,  # Ramulator guesstimate
    ...
    "DDR3_1066F": {
        "rate": 1066, "nBL": 4,
        "nCL": 7, "nRCD": 7, "nRP": 7, "nRAS": 20, "nRC": 27,
        "nWR": 8, "nRTP": 4, "nCWL": 6,
        "nCCD": 4, "nWTR": 4,
        "tCK_ps": 1875,
        "nCS": 2,  # Ramulator guesstimate
    ...
    "DDR3_1066G": {
        "rate": 1066, "nBL": 4,
        "nCL": 8, "nRCD": 8, "nRP": 8, "nRAS": 20, "nRC": 28,
        "nWR": 8, "nRTP": 4, "nCWL": 6,
        "nCCD": 4, "nWTR": 4,
        "tCK_ps": 1875,
        "nCS": 2,  # Ramulator guesstimate
    ...
    "DDR3_1333G": {
        "rate": 1333, "nBL": 4,
        "nCL": 8, "nRCD": 8, "nRP": 8, "nRAS": 24, "nRC": 32,
        "nWR": 10, "nRTP": 5, "nCWL": 7,
        "nCCD": 4, "nWTR": 5,
        "tCK_ps": 1500,
        "nCS": 2,  # Ramulator guesstimate
    },
    "DDR3_1333H": {
        "rate": 1333, "nBL": 4,
        "nCL": 9, "nRCD": 9, "nRP": 9, "nRAS": 24, "nRC": 33,
        "nWR": 10, "nRTP": 5, "nCWL": 7,
        "nCCD": 4, "nWTR": 5,
        "tCK_ps": 1500,
        "nCS": 2,  # Ramulator guesstimate
    ...
    "DDR3_1600H": {
        "rate": 1600, "nBL": 4,
        "nCL": 9, "nRCD": 9, "nRP": 9, "nRAS": 28, "nRC": 37,
        "nWR": 12, "nRTP": 6, "nCWL": 8,
        "nCCD": 4, "nWTR": 6,
        "tCK_ps": 1250,
        "nCS": 2,  # Ramulator guesstimate
    },
    ...
    "DDR3_1866K": {
        "rate": 1866, "nBL": 4,
        "nCL": 11, "nRCD": 11, "nRP": 11, "nRAS": 32, "nRC": 43,
        "nWR": 14, "nRTP": 7, "nCWL": 9,
        "nCCD": 4, "nWTR": 7,
        "tCK_ps": 1071,
        "nCS": 2,  # Ramulator guesstimate
    },
    ...
    "DDR3_2133L": {
        "rate": 2133, "nBL": 4,
        "nCL": 12, "nRCD": 12, "nRP": 12, "nRAS": 36, "nRC": 48,
        "nWR": 16, "nRTP": 8, "nCWL": 10,
        "nCCD": 4, "nWTR": 8,
        "tCK_ps": 938,
        "nCS": 2,  # Ramulator guesstimate
    },
    "DDR3_2133M": {
        "rate": 2133, "nBL": 4,
        "nCL": 13, "nRCD": 13, "nRP": 13, "nRAS": 36, "nRC": 49,
        "nWR": 16, "nRTP": 8, "nCWL": 10,
        "nCCD": 4, "nWTR": 8,
        "tCK_ps": 938,
        "nCS": 2,  # Ramulator guesstimate
