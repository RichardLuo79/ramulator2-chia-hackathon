...
from ramulator_chia.framework import archive as A
...
def test_seal_verify_relocate_and_extract_without_provider_imports(tmp_path):
    ...
    script = """import sys
from pathlib import Path
from ramulator_chia.framework.archive import verify
...
def test_inspection_cli_is_read_only_unless_extraction_is_requested(tmp_path):
    ...
    command = [sys.executable, "-m", "ramulator_chia.framework.inspect"]
