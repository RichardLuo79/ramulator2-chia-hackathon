    ...
    async def _run_generate_async(
        ...
        async with AsyncExitStack() as stack:
            ...
            for turn in count():
                ...
                # The caller may summarize completed history at this safe boundary.
                # It must keep native tool groups intact and persist every paid call.
                if self.context_compactor is not None:
                    await self.context_compactor(self, client, contents, config)
