...
Examples:
    python -m ramulator_chia.framework.inspect verify campaign-HASH.zip
    python -m ramulator_chia.framework.inspect manifest campaign-HASH.zip
    python -m ramulator_chia.framework.inspect extract campaign-HASH.zip --output new-directory
